...
/** Draws the graphic to indicate the static result is in loading. */

public class StaticLoadingGraphic extends StaticGraphicBase {
    ...
    StaticLoadingGraphic(GraphicOverlay overlay, ValueAnimator loadingAnimator) {
        super(overlay);
