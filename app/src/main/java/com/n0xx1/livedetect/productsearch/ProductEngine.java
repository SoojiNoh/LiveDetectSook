...
public class ProductEngine {
    ...
    private static final String TAG = "ProductEngine";
    ...
    public ProductEngine(Context context, Activity activity) {
        mContext = context;
        mActivity = activity;
//        searchRequestQueue = Volley.newRequestQueue(context);
    ...
    public void search(Activity activity, DetectedObject object, DetectResultListener listener) {
