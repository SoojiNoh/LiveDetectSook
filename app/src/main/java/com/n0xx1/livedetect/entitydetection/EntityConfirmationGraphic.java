 ...
 */
public class EntityConfirmationGraphic extends Graphic {

    private final com.n0xx1.livedetect.entitydetection.EntityConfirmationController confirmationController;
    ...
    EntityConfirmationGraphic(
            GraphicOverlay overlay, com.n0xx1.livedetect.entitydetection.EntityConfirmationController confirmationController) {
        super(overlay);
